...
if busca:
    for verbete, link in VERBETES.items():
        if busca.lower() in verbete.lower():
            st.write(f"**{verbete}** - {link}")

st.markdown("---")
st.caption("📱 App Permanente • ✨ Compartilhe com amigos!")
